...
function parallax(event) {
  this.querySelectorAll('.bg-layer').forEach(layer => {
    let speed = layer.getAttribute('data-speed');
    layer.style.transform = `translateX(${event.clientX * speed / 2000}px) translateY(${event.clientY * speed / 3500}px)`;
  });
}

document.addEventListener('mousemove', parallax); // Menu toggle

$('.burger-btn').on('click', function () {
  $('.menu-list').toggleClass('menu-list_active');
  $('.span-middle').toggleClass('span-middle_hidden');
  $('body header .menu-top-container .burger-container .burger-btn span').toggleClass('span_active');
...
$('.anchor a').on('click', function (e) {
  if (this.hash != '') {
    ...
    $('.menu-list').removeClass('menu-list_active');
    $('.burger-btn span').removeClass('span_active');
    $('.burger-btn .span-middle').removeClass('span-middle_hidden');
  }
}); // Activate a in section
...
jQuery(window).scroll(function () {
  ...
  $sections.each(function (i, el) {
    ...
    if (scroll > top && scroll < bottom) {
      $('.menu-list ul li a').removeClass('a-active');
      $('a[href="#' + id + '"]').addClass('a-active');
    }
  });
});
$(document).ready(function () {
  ...
  $(window).scroll(function () {
    if ($(window).scrollTop() > 100 && $(window).width() > 414) {
      $(".menu-top-container").addClass('menu-top-container_scroll');
      $(".menu-list").addClass('menu-list_scroll');
    } else {
      $(".menu-top-container").removeClass('menu-top-container_scroll');
      $(".menu-list").removeClass('menu-list_scroll');
    }
  }); // ajax form
